...
<body>
	...
	<center>
		<table class="listado">
			<tr>
				<th>NRO</th><th>NOMBRE</th><th>AP</th><th>AM</th><th>CI</th><th>TELEFONO</th><th>UBICACION</th>
			...
			<tr>
				...
				<td align="center">{$r.ubicacion}</td>
				<td align="center">
		...
		<td align="center">
			<form name="formElimi{$r.id_empleado}" method="post" action="empleado_eliminar.php">
				<input type="hidden" name="id_empleado" value="$r.empleado">
				<a href="javascript:document.formElimi{$r.id_empleado}.submit();" title="Eliminar Empleado Sistema" onclick="javascript:return(confirm('Desea realmente Eliminar al Empleado...?')); location.href='empleados_eliminar.php'">
					Eliminar>>
				</a>
			</form>
		</td>
